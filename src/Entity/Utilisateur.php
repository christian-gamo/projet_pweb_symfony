 ...
 * @UniqueEntity(fields={"email"}, message="Cette e-mail est déja utilisé")
 */
class Utilisateur implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Facturation::class, mappedBy="idC", orphanRemoval=true)
     */
    ...
    public function getIsLoueur(): ?bool
    {
        return $this->isLoueur;
    }

    public function setIsLoueur(bool $isLoueur): self
    {
        $this->isLoueur = $isLoueur;
    ...
    public function removeFacturation(Facturation $facturation): self
    {
        if ($this->facturations->contains($facturation)) {
            ...
            if ($facturation->getIdC() === $this) {
                $facturation->setIdC(null);
            }
        }
